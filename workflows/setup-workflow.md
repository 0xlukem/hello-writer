...
- This workflow generates the `config/content-engine.yml` file and all `agents/` definitions.
...
- Output: `config/content-engine.yml`, `agents/*.md`, `agents/memory/*.md`, `output/` directory.
...
- Provide the exact next command to run: `opencode run workflows/content-engine.md`
